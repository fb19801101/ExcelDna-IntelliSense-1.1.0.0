...
namespace ExcelDna.IntelliSense
{
    ...
    sealed class SingleThreadSynchronizationContext : SynchronizationContext
    {
        ...
        public void RunOnCurrentThread()
        {
            ...
            Logger.Monitor.Info(string.Format("SingleThreadSynchronizationContext Running (Thread {0})!",_threadId));
            foreach (var workItem in _queue.GetConsumingEnumerable())
            {
                ...
                {
                    Logger.Monitor.Warn(string.Format("SingleThreadSynchronizationContext ### Unhandled exception (Thread {0}) - {1}",_threadId,ex));
                }
            }
