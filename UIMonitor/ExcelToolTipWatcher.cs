...
namespace ExcelDna.IntelliSense
{
    class ExcelToolTipWatcher : IDisposable
    {
        ...
        public class ToolTipChangeEventArgs : EventArgs
        {
            ...
            public override string ToString() {return string.Format("{0}:0x{1:x}",ChangeType,Handle);}
        }
        ...
        public IntPtr GetLastToolTipOrZero() 
        {
            return _toolTips.Count > 0 ? _toolTips[_toolTips.Count - 1] : IntPtr.Zero;
        }
