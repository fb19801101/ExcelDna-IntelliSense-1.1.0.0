...
namespace ExcelDna.IntelliSense
{
    ...
    public static class IntelliSenseServer
    {
        ...
        public static void Install()
        {
            ...
            Logger.Initialization.Info(string.Format("IntelliSenseServer.Install Begin: Version {0} in {1}", ServerVersion, AppDomain.CurrentDomain.FriendlyName));
            if (IsDisabled())
                return;
            ...
            {
                Logger.Initialization.Info(string.Format("IntelliSenseServer not being activated now. Active Version: {0}",activeInfo.Version));
            }
        ...
        {
            Logger.Initialization.Info(string.Format("IntelliSenseServer.Uninstall Begin: Version {0} in {1}", ServerVersion, AppDomain.CurrentDomain.FriendlyName));
        ...
        internal static bool Activate()
        {
            ...
            {
                Logger.Initialization.Error(string.Format("IntelliSenseServer.Activate failed: {0}",ex));
                return false;
            }
        }
        ...
        internal static bool Deactivate()
        {
            ...
            {
                Logger.Initialization.Error(string.Format("IntelliSenseServer.Deactivate error: {0}",ex));
                return false;
            }
        }
        ...
        internal static void RefreshProviders()
        {
            ...
            {
                // TODO: Log
                Logger.Initialization.Error(string.Format("IntelliSenseServer.RefreshProviders error: {0}",ex));
            }
        }
        ...
        static bool IsDisabled()
        {
            ...
            if (isDisabled)
            {
                Logger.Initialization.Info(string.Format("IntelliSenseServer version {0} is disabled. MachineDisabled: {1}, UserDisabled: {2}, EnvironmentDisabled: {3}", thisVersion, machineDisabled, userDisabled, environmentDisabled));
            }
        ...
        static bool ActivateServer(RegistrationInfo registrationInfo)
        {
            ...
            {
                Logger.Initialization.Error(ex, string.Format("IntelliSenseServer {0} could not be activated.",registrationInfo.ToRegistrationString()));
                return false;
            }
        }
        ...
        static bool DeactivateServer(RegistrationInfo registrationInfo)
        {
            ...
            {
                Logger.Initialization.Error(ex, string.Format("IntelliSenseServer Deactivate call for {0} failed.",registrationInfo.ToRegistrationString()));
                return false;
            }
        }
        ...
        class RegistrationInfo : IComparable<RegistrationInfo>
        {
            ...
            public string ToRegistrationString() {return string.Format("{0},{1:N},{2}",XllPath,ServerId,Version);}
            public int CompareTo(RegistrationInfo other) { return CompareVersions(Version, other.Version);}
            public static string GetControlMacroName(Guid serverId) {return string.Format("IntelliSenseServerControl_{0:N}",serverId);}
            public string GetControlMacroName() { return GetControlMacroName(ServerId); }
        ...
        {
            var method = typeof(IntelliSenseServer).GetMethod("IntelliSenseServerControl", BindingFlags.Static | BindingFlags.NonPublic);
